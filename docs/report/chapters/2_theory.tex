...
Se compone de múltiples técnicas diferentes, pero las más relevantes para este proyecto son: la normalización, la detención anticipada o \textit{Early Stopping} y la inicialización de los pesos.

...
\begin{table}[h]
    ...
    \end{tabular}
    \caption{Correpondencia entre nombres de las características de Todd en castellano e inglés junto con sus abreviación.}
...
\label{section4:nas}
El procesamiento de mallas 3D mediante redes neuronales constituye un campo aún en etapa experimental y en rápida evolución. Debido a su novedad, no existe un consenso establecido sobre cómo tratar estos datos de manera óptima. Como resultado, no se dispone de modelos preentrenados sobre mallas 3D con las características específicas requeridas en este trabajo, particularmente en el contexto de ExMeshCNN y con la resolución necesaria para abordar el presente problema.
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|c|c|}
        \hline
        \rowcolor[HTML]{D33333} 
        {\color[HTML]{FFFFFF} Parámetro} & {\color[HTML]{FFFFFF} Valores posibles} & {\color[HTML]{FFFFFF} Tipo} \\ \hline
    ...
    \end{tabular}
    \caption[Hiperparámetros utilizados por Optuna]{Hiperparámetros utilizados en el entrenamiento para la optimización de hiperparámetros y NAS de la red mediante Optuna. \textbf{\textdagger}: Solo se aplica si la función de pérdida es CB.}

...
\begin{figure}[htbp]
    ...
    \begin{minipage}{\linewidth}
        ...
        \end{tabular}
        \captionof{table}{Característica \textbf{AF}: Datos de entrada, estructura de red e hiperparámetros del mejor modelo.}
    ...
    \caption{Característica \textbf{AF}: Matriz de confusión del mejor modelo en datos de test. Leyenda: \textbf{0}: Porosidad Regular, \textbf{1}: Muy Definidas, \textbf{2}: Poco Profundas, \textbf{3}: Restos de Surcos, \textbf{4}: No hay surcos.}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{\linewidth}
        ...
        \end{tabular}
        \captionof{table}{Característica \textbf{BN}: Datos de entrada, estructura de red e hiperparámetros del mejor modelo.}
    ...
    \caption{Característica \textbf{BN}: Matriz de confusión del mejor modelo en datos de test. Leyenda: \textbf{0}: Ausente, \textbf{1}: Presente.}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{\linewidth}
        ...
        \end{tabular}
        \captionof{table}{Características \textbf{DP} y \textbf{DM}: Datos de entrada, estructura de red e hiperparámetros del mejor modelo.}
    ...
    \caption{Característica \textbf{DM}: Matriz de confusión del mejor modelo en datos de test. Leyenda: \textbf{0}: No Definido, \textbf{1}: En Formación, \textbf{2}: Definido.}
    \label{fig5:DM_confusion_matrix}
    \includegraphics[width=0.4\linewidth]{figures/5_experiments/multi-dp-cm.pdf}
    \caption{Característica \textbf{DP}: Matriz de confusión del mejor modelo en datos de test. Leyenda: \textbf{0}: Ausente, \textbf{1}: Presente.}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{\linewidth}
        ...
        \end{tabular}
        \captionof{table}{Característica \textbf{IP}: Datos de entrada, estructura de red e hiperparámetros del mejor modelo.}
    ...
    \caption{Característica \textbf{IP}: Matriz de confusión del mejor modelo en datos de test. Leyenda: \textbf{0}: No, \textbf{1}: Mediana, \textbf{2}: Sí.}
...
\begin{figure}[htbp]
    ...
    \end{tabular}
        ...
        \end{tabular}
        \captionof{table}{Característica \textbf{LSE}: Datos de entrada, estructura de red e hiperparámetros del mejor modelo.}
    ...
    \caption{Característica \textbf{LSE}: Matriz de confusión del mejor modelo en datos de test. Leyenda: \textbf{0}: No Definido, \textbf{1}: Definido.}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{\linewidth}
        ...
        \end{tabular}
        \captionof{table}{Característica \textbf{USE}: Datos de entrada, estructura de red e hiperparámetros del mejor modelo.}
    ...
    \caption{Característica \textbf{USE}: Matriz de confusión del mejor modelo en datos de test. Leyenda: \textbf{0}: No Definido, \textbf{1}: Definido.}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{\linewidth}
        ...
        \end{tabular}
        \captionof{table}{Característica \textbf{VB}: Datos de entrada, estructura de red e hiperparámetros del mejor modelo.}
    ...
    \caption{Característica \textbf{VB}: Matriz de confusión del mejor modelo en datos de test. Leyenda: \textbf{0}: Ausente, \textbf{1}: En Formación, \textbf{2}: Presente.}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{\linewidth}
        ...
        \end{tabular}
        \captionof{table}{Característica \textbf{VM}: Datos de entrada, estructura de red e hiperparámetros del mejor modelo.}
    ...
    \caption{Característica \textbf{VM}: Matriz de confusión del mejor modelo en datos de test. Leyenda: \textbf{0}: Ausente, \textbf{1}: En Formación, \textbf{2}: Formado, Sin Excrecencias, \textbf{3}: Formado, Pocas Excrecencias, \textbf{4}: Formado, Muchas Excrecencias.}

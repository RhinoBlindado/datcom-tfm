...
% ********************************************************************
\newcommand{\myTitle}{Clasificación automática de criterios morfológicos para estimación de la edad en la muerte a partir de modelos 3D de la sínfisis del pubis\xspace}
...
\begin{document}
    ...
    % Metodología 
    \input{chapters/4_materials_and_methods}
